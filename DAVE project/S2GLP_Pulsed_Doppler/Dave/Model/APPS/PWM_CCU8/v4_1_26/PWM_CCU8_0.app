...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PWM_CCU8" URI="http://resources/4.1.26/app/PWM_CCU8/0" description="PWM APP using one timer slice of CCU8, with external events and dead time support, to generate up to 4 PWM outputs." mode="NOTSHARABLE" version="4.1.26" minDaveVersion="4.3.2" instanceLabel="PWM_CCU8_BGT_VCC" appLabel="" containingProxySignal="true">
  ...
  <virtualSignals name="event_ch1_cmp_match" URI="http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_ch1_compare_match_interrupt" hwSignal="cmd1s_cmu1s" hwResource="//@hwResources.0" visible="true"/>
  ...
  <virtualSignals name="Out - CCU8 CH1 Invert PAD" URI="http://resources/4.1.26/app/PWM_CCU8/0/vs_port_ch1_out1" hwSignal="pad" hwResource="//@hwResources.2" required="false"/>
  ...
  <hwResources name="PWM_CCU8 CH1 Invert Out" URI="http://resources/4.1.26/app/PWM_CCU8/0/hwres_port_ch1_out1" resourceGroupUri="" required="false" mResGrpUri="port/p/*/pad/*"/>
  ...
  <hwResources name="PWM_CCU8 CH1 Direct Out" URI="http://resources/4.1.26/app/PWM_CCU8/0/__pin_hwres_port_ch1_out0" resourceGroupUri="devicepackage/0/l5" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.51"/>
  </hwResources>
  <hwResources name="PWM_CCU8 CH1 Invert Out" URI="http://resources/4.1.26/app/PWM_CCU8/0/__pin_hwres_port_ch1_out1" resourceGroupUri="" required="false" mResGrpUri="devicepackage/0/*"/>
  ...
  <connections URI="http://resources/4.1.26/app/PWM_CCU8/0/http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_st/http://resources/4.1.26/app/PWM_CCU8/1/vs_ccu8_cc8_gp0_unsync" sourceSignal="timer_st" targetSignal="ext_event0" srcVirtualSignal="//@virtualSignals.7">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="PWM_CCU8_1.app#//@virtualSignals.14"/>
    <targetVirtualSignal href="PWM_CCU8_1.app#//@virtualSignals.14"/>
  </connections>
  <connections URI="http://resources/4.1.26/app/PWM_CCU8/0/http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_st/http://resources/4.1.26/app/PWM_CCU8/1/vs_ccu8_cc8_gp1_unsync" sourceSignal="timer_st" targetSignal="ext_event1" srcVirtualSignal="//@virtualSignals.7">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="PWM_CCU8_1.app#//@virtualSignals.15"/>
    <targetVirtualSignal href="PWM_CCU8_1.app#//@virtualSignals.15"/>
  </connections>
  <connections URI="http://resources/4.1.26/app/PWM_CCU8/0/http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_st/http://resources/4.1.26/app/PWM_CCU8/4/vs_ccu8_cc8_gp0_unsync" sourceSignal="timer_st" targetSignal="ext_event0" srcVirtualSignal="//@virtualSignals.7">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="PWM_CCU8_4.app#//@virtualSignals.14"/>
    <targetVirtualSignal href="PWM_CCU8_4.app#//@virtualSignals.14"/>
  </connections>
  <connections URI="http://resources/4.1.26/app/PWM_CCU8/0/http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_st/http://resources/4.1.26/app/PWM_CCU8/4/vs_ccu8_cc8_gp1_unsync" sourceSignal="timer_st" targetSignal="ext_event1" srcVirtualSignal="//@virtualSignals.7">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="PWM_CCU8_4.app#//@virtualSignals.15"/>
    <targetVirtualSignal href="PWM_CCU8_4.app#//@virtualSignals.15"/>
  </connections>
  <connections URI="http://resources/4.1.26/app/PWM_CCU8/0/http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_st/http://resources/4.1.26/app/PWM_CCU8/5/vs_ccu8_cc8_gp0_unsync" sourceSignal="timer_st" targetSignal="ext_event0" srcVirtualSignal="//@virtualSignals.7">
    <downwardMapList xsi:type="ResourceModel:VirtualSignal" href="PWM_CCU8_5.app#//@virtualSignals.14"/>
    <targetVirtualSignal href="PWM_CCU8_5.app#//@virtualSignals.14"/>
  </connections>
  <connections URI="http://resources/4.1.26/app/PWM_CCU8/0/http://resources/4.1.26/app/PWM_CCU8/0/vs_ccu8_cc8_ch1_compare_match_interrupt/http://resources/4.0.8/app/INTERRUPT/4/vs_nvic_signal_in" sourceSignal="event_ch1_cmp_match" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.2">
